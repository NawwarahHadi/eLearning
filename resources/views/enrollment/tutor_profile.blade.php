...
<div class="container mt-5">
        ...
        <div class="card-body p-0">
            <div class="row g-0">
                {{-- LEFT COLUMN: TUTOR BIO --}}
                 <div class="col-md-4 bg-light p-10 text-center border-end">
                    <div class="symbol symbol-125px symbol-circle mb-5 shadow">
                        {{-- Pulling Profile photo from tutor_profiles --}}
                    ...
                    <div class="text-start">
                        ...
                        <p class="small text-dark leading-relaxed">
                            {{-- Accessing dynamic style description from tutor_profiles --}}
                ...
                <div class="col-md-8 p-10">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="p-6 bg-light-primary rounded border border-dashed border-primary">
                            <ul class="mb-0 text-gray-700">
                                {{-- Hardcoded "Sensible" Objectives if column is empty --}}
                    ...
                    <h5 class="mb-3 text-dark fw-bold"><i class="fas fa-clock me-2 text-warning"></i> Available Learning Slots</h5>
                    <p class="text-muted small mb-4">Please select one session to proceed with your enrollment request.</p>
    ...
    <div class="row g-3 mb-8">
        ...
        <div class="col-sm-6">
            ...
            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex flex-column text-start p-5"
                   for="slot_{{ $slot->id }}">
